...
namespace GrooveSharkWindowsPhone.Views
{
    ...
    /// </summary>
    public sealed partial class AccountView : BaseView
    {
        ...
        private void PivotSelectedIndexChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            CollectionPath.Fill = FavouritesPath.Fill = PlaylistPath.Fill = new SolidColorBrush(Colors.White);
